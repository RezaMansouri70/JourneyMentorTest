...
namespace Application.Features.Airport.Command.Validations
{
  
    public class GetAirportsCommandValidator : AbstractValidator<GetAirportsCommand>
    {
        public GetAirportsCommandValidator()
        {
